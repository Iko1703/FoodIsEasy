...
1. ✅ Схема БД + Docker + Flyway
2. ✅ Профиль и предпочтения (API + UI)
3. ✅ История питания + планировщик меню
4. ✅ Рекомендации (rule-based)
5. ✅ Аналитика рациона (графики ккал, БЖУ, приёмы пищи)
6. ✅ Группы + голосование + общая корзина с кнопкой «Заказать»
7. ✅ Страница REST API (`/api`) + полировка UI
